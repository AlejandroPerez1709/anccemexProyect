...
// Recuperar errores y datos del formulario si los hay. Prioriza los datos de sesión (si falló una validación)
...
<script src="<?php echo BASE_URL; ?>/assets/js/socios-edit.js"></script>