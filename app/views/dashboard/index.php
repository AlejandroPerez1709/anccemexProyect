...
<div class="dashboard-period-filters">
    <a href="index.php?route=dashboard&periodo=mes" class="<?php echo ($periodo === 'mes') ? 'active' : ''; ?>">Este Mes</a>
    <a href="index.php?route=dashboard&periodo=trimestre" class="<?php echo ($periodo === 'trimestre') ? 'active' : ''; ?>">Este Trimestre</a>
    <a href="index.php?route=dashboard&periodo=anio" class="<?php echo ($periodo === 'anio') ? 'active' : ''; ?>">Este Año</a>
    <a href="index.php?route=dashboard" class="<?php echo ($periodo === 'all_time') ? 'active' : ''; ?>">Desde Siempre</a>
</div>
<div class="dashboard-kpi-cards">
    ...
    <div class="stat-card border-success">
        ...
        <div class="stat-card-info">
            <span class="stat-card-title"><?php echo $titulo_kpi_servicios; ?></span>
            <span class="stat-card-number"><?php echo $statsServicios['completados_periodo']; ?></span>
        </div>
    </div>
...
<div class="dashboard-grid">
    ...
    <div class="dashboard-list-container">
        <h3 class="dashboard-section-title">Actividad Reciente</h3>
         <table>
            <thead><tr><th>N°</th><th>Socio</th><th>Estado</th></tr></thead>
            <tbody>
...
<div class="dashboard-module-cards">
    <a href="index.php?route=socios_index" class="module-card module-card-socios">
        ...
        <div class="module-card-content">
            <div class="module-card-number"><?php echo $totalSocios; ?></div>
            <div class="module-card-title"><?php echo $titulo_kpi_nuevos; ?></div>
        </div>
    </a>
    <a href="index.php?route=ejemplares_index" class="module-card module-card-ejemplares">
        ...
        <div class="module-card-content">
            <div class="module-card-number"><?php echo $totalEjemplares; ?></div>
            <div class="module-card-title"><?php echo $titulo_kpi_nuevos; ?></div>
        </div>
    </a>
    <a href="index.php?route=medicos_index" class="module-card module-card-medicos">
        ...
        <div class="module-card-content">
            <div class="module-card-number"><?php echo $totalMedicos; ?></div>
            <div class="module-card-title"><?php echo $titulo_kpi_nuevos; ?></div>
        </div>
    </a>
    <a href="index.php?route=empleados_index" class="module-card module-card-empleados">
        ...
        <div class="module-card-content">
            <div class="module-card-number"><?php echo $totalEmpleados; ?></div>
            <div class="module-card-title"><?php echo $titulo_kpi_nuevos; ?></div>
        </div>
    </a>
</div>
