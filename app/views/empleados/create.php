...
$minFechaIngreso = date('Y-m-d', strtotime('-40 years')); // Aprox 40 años atrás
...
document.addEventListener('DOMContentLoaded', function() {
    // Ya no necesitamos el script para poner max, lo hacemos con PHP
    // Script para validar email (se mantiene)
